...
# Table-frame offsets from the studio canvas land on this counter.
KITCHEN_COUNTER = {
    "table_pos": (0.72, 0.0, 0.40),
    "table_size": (0.42, 0.32, 0.02),
    "table_rgba": (0.45, 0.32, 0.18, 1.0),
    "camera_pos": (1.85, -1.35, 1.20),
    "camera_target": (0.45, 0.0, 0.55),
}
